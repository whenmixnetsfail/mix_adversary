...
- [Configuration Parameters]: The configuration parameters match those used in Fig. 4, specifically: L = 3, W = 300, and m = 500 (1 MB of data).
...
- [Configuration Parameters]: The configuration parameters match those used in Fig. 5, specifically: L = 3, W = 300, and $\mu$ = 30000 packets/s.
